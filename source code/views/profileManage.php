...
<head>
    <meta charset="utf-8">
    <title>Admin Management - User Profiles</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="card-container">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">Add new user profiles to the database.</p>
                    <div class="btn-container">
                        <a href="profileAdd.php" class="btn btn-primary">Add</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">Update existing user profile details.</p>
                    <div class="btn-container">
                        <a href="profileUpdate.php" class="btn btn-warning">Update</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">View User Profiles</h5>
                    <p class="card-text">View all user profiles in the database.</p>
                    <div class="btn-container">
                        <a href="profileView.php" class="btn btn-success">View</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Delete User Profile</h5>
                    <p class="card-text">Remove user profiles from the database.</p>
                    <div class="btn-container">
                        <a href="profileDelete.php" class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
        </div>
