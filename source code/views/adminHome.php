...
<body>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h5 class="card-title">Movie Detail</h5>
              <p class="card-text">Click for movie list.</p>
              <a href="movieDetail.php" class="btn btn-outline-light">Go</a>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Click for movie rating.</p>
              <a href="adminRatingControl.php" class="btn btn-outline-light">Go</a>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <a href="adminFeedbackControl.php" class="btn btn-outline-light">Go</a>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <a href="profileManage.php" class="btn btn-outline-light">Go</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src=" https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  </script>
</body>
