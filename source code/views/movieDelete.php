                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="../controllers/delete.php?movie_id=<?php echo $row["movie_id"]; ?>" onclick="return confirm('Are you sure you want to delete this movie record?')">Delete</a>
                            </td>
                        </tr>
                    <?php $count++;
                    } ?>
