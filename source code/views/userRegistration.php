...
if (isset($_REQUEST['username'])) {
    ...
    if ($result = mysqli_query($con, $query)) {
        $status = "User Register Successfully.";  // Set the flag to true if registration is successful
    }
}
?>
<!DOCTYPE html>
...
<body>
    <div class="container text-center">
        ...
        <p class="mt-3">Already registered? <a href='userLogin.php'>Login here</a></p>
    </div>
