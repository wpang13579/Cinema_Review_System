            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        // Assuming the profile picture path is stored relative to the controllers directory
                    ...
                    ?>
                        <tr>
                            ...
                            <td><img src="<?php echo $profile_picture_path; ?>" alt="Profile Picture" class="profile-picture"></td>
                        </tr>
                    <?php $count++;
                    } ?>
                </tbody>
