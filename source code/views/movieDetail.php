        ...
        <div class="card-container">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">Add new movies to the database.</p>
                    <div class="btn-container">
                        <a href="movieAdd.php" class="btn btn-primary">Add</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="card-text">Update existing movie details.</p>
                    <div class="btn-container">
                        <a href="movieUpdate.php" class="btn btn-warning">Update</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Delete Movie</h5>
                    <p class="card-text">Remove movies from the database.</p>
                    <div class="btn-container">
                        <a href="movieDelete.php" class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">View Movie</h5>
                    <p class="card-text">View all movies in the database.</p>
                    <div class="btn-container">
                        <a href="movieView.php" class="btn btn-success">View</a>
                    </div>
                </div>
            </div>
        </div>
