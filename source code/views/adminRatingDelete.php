...
<body>
    ...
    <main class="container">
        ...
        <div class="table-responsive">
            <table class="table table-dark table-striped table-hover">
                ...
                <tbody>
                    ...
                    $sel_query = "
                    SELECT r.rating_id, r.rating_score, r.daterating, m.movie_name, u.username
                    FROM rating r
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $row["daterating"]; ?></td>

                            <td>
                                <a href="../controllers/adminRatingDelete.php?rating_id=<?php echo $row["rating_id"]; ?>" onclick="return confirm('Are you sure you want to delete this rating record?')">Delete</a>
                            </td>
                        </tr>
                    <?php $count++;
                    } ?>
        ...
        <div class="back-button">
            <a href="adminRatingControl.php" class="btn btn-secondary">Back</a>
        </div>
    </main>
