...
<head>
    <meta charset="utf-8">
    <title>Admin Feedback Control</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <div class="btn-container">
                        <a href="adminFeedbackView.php" class="btn btn-success">View</a>
                    </div>
                </div>
            </div>
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Remove Feedback</h5>
                    <p class="card-text">Remove user Feedback.</p>
                    <div class="btn-container">
                        <a href="adminFeedbackDelete.php" class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
